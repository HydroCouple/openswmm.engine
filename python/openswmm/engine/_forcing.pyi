...
class Forcing:
    def node_temperature(self, node: int | str, value: float, *, mode: ForcingMode = ..., persist: bool = ...) -> None: ...
    def node_age(self, node: int | str, value: float, *, mode: ForcingMode = ..., persist: bool = ...) -> None: ...
    def link_seepage(self, link: int | str, value: float, *, mode: ForcingMode = ..., persist: bool = ...) -> None: ...
    def element_climate(self, kind: int, element: int | str, variable: int, value: float, *, mode: ForcingMode = ..., persist: bool = ...) -> None: ...
    def element_climate_get(self, kind: int, element: int | str, variable: int) -> tuple[float, ForcingMode | None]: ...
