...
CASES = [
    ...
    ("front_matter_stale",
     "manuals/reference/quality.md",
     "Figure 10-1. The transport policy matrix", "Figure 10-1. A stale caption nobody wrote",
     "stale — quality: List of Figures"),
    ("front_matter_missing_entry",
     "manuals/reference/hydraulics.md",
     "Figure 9-6 Where a node spill is booked", "Figure 9-9 Where a node spill is booked",
     "stale — hydraulics: List of Figures"),
    ("hotspot_bad_box",
     "manuals/engine/sections/Chapter1-ConceptualModel.md",
