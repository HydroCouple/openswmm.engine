...
openswmmcore_DEBUG_MODE = os.getenv('DEBUG', 'False').lower() in ('true', '1', 't')
...
def get_cmake_args():
    ...
    cmake_args = os.getenv(
        "openswmmcore_CMAKE_ARGS", [f"--preset={platform_system}{debug_qualifier()}"]
    )
