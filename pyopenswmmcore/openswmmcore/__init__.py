"""
openswmmcore Python API

This module provides a Python interface to the openswmmcore library.
...
__version__ = importlib.metadata.version('openswmmcore')

from openswmmcore import *
