/**
 * @file xsect_tables.hpp
 * @brief Cross-section lookup tables — translated from legacy xsect.dat.
 *
 * @details All values are copied exactly from src/legacy/engine/xsect.dat
 *          (SWMM 5.2.1, Build 5.2.1, 08/01/22). No values have been rounded
 *          or modified. The Amax[] array is from src/legacy/engine/xsect.c.
 *
 *          Tables use the naming convention:
 *            A_xxx   = area/fullarea vs depth/fulldepth
 *            Y_xxx   = depth/fulldepth vs area/fullarea
 *            W_xxx   = width/maxwidth vs depth/fulldepth
 *            R_xxx   = hydrad/hydradfull vs depth/fulldepth
 *            S_xxx   = sectionfactor/sectionfactorfull vs area/areafull
 *
 * @note INTERNAL HEADER — not installed. Used by XSection.cpp and XSectBatch.cpp.
 * @ingroup new_engine
 *
...
#ifndef OPENSWMM_XSECT_TABLES_HPP
#define OPENSWMM_XSECT_TABLES_HPP

namespace openswmm::xsect_tables {

// ============================================================================
// Amax — ratio of area at max flow to full area (from xsect.c)
// ============================================================================

static constexpr double Amax[26] = {
    1.0,     //  0 - DUMMY
    0.9756,  //  1 - CIRCULAR
    0.9756,  //  2 - FILLED_CIRCULAR
    0.97,    //  3 - RECT_CLOSED
    1.0,     //  4 - RECT_OPEN
    1.0,     //  5 - TRAPEZOIDAL
    1.0,     //  6 - TRIANGULAR
    ...
    0.98,    // 10 - RECT_ROUND
    0.96,    // 11 - MOD_BASKET
    0.96,    // 12 - HORIZ_ELLIPSE
    0.96,    // 13 - VERT_ELLIPSE
    0.92,    // 14 - ARCH
    0.96,    // 15 - EGGSHAPED
    0.96,    // 16 - HORSESHOE
    0.96,    // 17 - GOTHIC
    0.98,    // 18 - CATENARY
    0.98,    // 19 - SEMIELLIPTICAL
    0.96,    // 20 - BASKETHANDLE
    0.96,    // 21 - SEMICIRCULAR
    1.0,     // 22 - IRREGULAR
    0.96,    // 23 - CUSTOM
    0.9756,  // 24 - FORCE_MAIN
    1.0      // 25 - STREET_XSECT
};
...
static constexpr int N_A_Circ = 51;
static constexpr double A_Circ[51] = {
...
static constexpr int N_R_Circ = 51;
static constexpr double R_Circ[51] = {
...
static constexpr int N_Y_Circ = 51;
static constexpr double Y_Circ[51] = {
...
static constexpr int N_S_Circ = 51;
static constexpr double S_Circ[51] = {
...
static constexpr int N_W_Circ = 51;
static constexpr double W_Circ[51] = {
...
static constexpr int N_A_Egg = 26;
static constexpr double A_Egg[26] = {
...
static constexpr int N_R_Egg = 26;
static constexpr double R_Egg[26] = {
...
static constexpr int N_Y_Egg = 51;
static constexpr double Y_Egg[51] = {
...
static constexpr int N_S_Egg = 51;
static constexpr double S_Egg[51] = {
...
static constexpr int N_W_Egg = 26;
static constexpr double W_Egg[26] = {
...
static constexpr int N_A_Horseshoe = 26;
static constexpr double A_Horseshoe[26] = {
...
static constexpr int N_R_Horseshoe = 26;
static constexpr double R_Horseshoe[26] = {
...
static constexpr int N_Y_Horseshoe = 51;
static constexpr double Y_Horseshoe[51] = {
...
static constexpr int N_S_Horseshoe = 51;
static constexpr double S_Horseshoe[51] = {
...
static constexpr int N_W_Horseshoe = 26;
static constexpr double W_Horseshoe[26] = {
...
static constexpr int N_Y_Gothic = 51;
static constexpr double Y_Gothic[51] = {
...
static constexpr int N_S_Gothic = 51;
static constexpr double S_Gothic[51] = {
...
static constexpr int N_W_Gothic = 21;
static constexpr double W_Gothic[21] = {
...
static constexpr int N_Y_Catenary = 51;
static constexpr double Y_Catenary[51] = {
...
static constexpr int N_S_Catenary = 51;
static constexpr double S_Catenary[51] = {
...
static constexpr int N_W_Catenary = 21;
static constexpr double W_Catenary[21] = {
...
static constexpr int N_Y_SemiEllip = 51;
static constexpr double Y_SemiEllip[51] = {
...
static constexpr int N_S_SemiEllip = 51;
static constexpr double S_SemiEllip[51] = {
...
static constexpr int N_W_SemiEllip = 21;
static constexpr double W_SemiEllip[21] = {
...
static constexpr int N_A_Baskethandle = 26;
static constexpr double A_Baskethandle[26] = {
...
static constexpr int N_R_Baskethandle = 26;
static constexpr double R_Baskethandle[26] = {
...
static constexpr int N_Y_BasketHandle = 51;
static constexpr double Y_BasketHandle[51] = {
...
static constexpr int N_S_BasketHandle = 51;
static constexpr double S_BasketHandle[51] = {
...
static constexpr int N_W_BasketHandle = 26;
static constexpr double W_BasketHandle[26] = {
...
static constexpr int N_Y_SemiCirc = 51;
static constexpr double Y_SemiCirc[51] = {
...
static constexpr int N_S_SemiCirc = 51;
static constexpr double S_SemiCirc[51] = {
...
static constexpr int N_W_SemiCirc = 21;
static constexpr double W_SemiCirc[21] = {
...
static constexpr int N_A_HorizEllipse = 26;
static constexpr double A_HorizEllipse[26] = {
...
static constexpr int N_R_HorizEllipse = 26;
static constexpr double R_HorizEllipse[26] = {
...
static constexpr int N_W_HorizEllipse = 26;
static constexpr double W_HorizEllipse[26] = {
...
static constexpr int N_A_VertEllipse = 26;
static constexpr double A_VertEllipse[26] = {
...
static constexpr int N_R_VertEllipse = 26;
static constexpr double R_VertEllipse[26] = {
...
static constexpr int N_W_VertEllipse = 26;
static constexpr double W_VertEllipse[26] = {
    .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600,
    .9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542,
    .8000,.7332,.6499,.5426,.3919,.0
};
...
static constexpr int N_A_Arch = 26;
static constexpr double A_Arch[26] = {
...
static constexpr int N_R_Arch = 26;
static constexpr double R_Arch[26] = {
...
static constexpr int N_W_Arch = 26;
static constexpr double W_Arch[26] = {
...
// ============================================================================
// Standard ellipse and arch size tables
// ============================================================================

static constexpr int NumCodesEllipse = 23;

static constexpr double MinorAxis_Ellipse[23] = {
    14,19,22,24,27,29,32,34,38,43,48,53,58,63,68,72,77,82,87,92,97,106,116
};

static constexpr double MajorAxis_Ellipse[23] = {
    23,30,34,38,42,45,49,53,60,68,76,83,91,98,106,113,121,128,136,143,151,166,180
};

static constexpr double Afull_Ellipse[23] = {
...
static constexpr double Rfull_Ellipse[23] = {
...
static constexpr int NumCodesArch = 102;

static constexpr double Yfull_Arch[102] = {
...
static constexpr double Wmax_Arch[102] = {
...
static constexpr double Afull_Arch[102] = {
...
static constexpr double Rfull_Arch[102] = {
...
#endif // OPENSWMM_XSECT_TABLES_HPP
