 ...
 * \brief JSON progress serialization for openswmm-legacy-worker-5.2.4.
 *
 ...
 *
 * Verbatim copy of openswmm.engine/src/legacy/worker/worker_progress.h (the
 * 5.3.0 worker): the GUI's SimulationRunner speaks exactly this protocol, so
 * the two workers must stay line-compatible. Keep them identical.
 */

#ifndef SWMM524_WORKER_PROGRESS_H
#define SWMM524_WORKER_PROGRESS_H
...
#endif // SWMM524_WORKER_PROGRESS_H
