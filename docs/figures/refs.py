...
FEATURE_REFS = {
    ...
    "infiltration.mesh_per_cell": Y + "ch8_mesh_surface",
    "infiltration.mesh_constant": Y + "ch8_mesh_surface",
    "snowmelt.degree_day": Y + "ch6_snowmelt",
    "rain.mesh_natural_neighbour": Y + "ch8_mesh_surface",
    "evaporation.mesh": Y + "ch8_mesh_surface",
    "lid.layered": Q + "ch6_lid_controls",
    "lid.storage_node": Q + "ch6_lid_controls",                 # -> hydrology_ref_ch10_planned when it lands
    "lid.detailed_output": Q + "ch6_lid_controls",              # -> hydrology_ref_ch10_planned when it lands
    "quality.buildup_washoff": Q + "ch3_pollutant_buildup",
    "quality.mesh_surface": Q + "ch10_mesh_quality",
    ...
    "groundwater.mesh_two_layer": Y + "ch9_mesh_groundwater",
    "groundwater.mesh_per_subcatch": Y + "ch9_mesh_groundwater",
    "groundwater.soil.gardner": Y + "ch9_mesh_groundwater",
    "groundwater.soil.russo": Y + "ch9_mesh_groundwater",
    "groundwater.soil.brooks_corey": Y + "ch9_mesh_groundwater",
    "groundwater.soil.van_genuchten": Y + "ch9_mesh_groundwater",
    "groundwater.transport": Y + "ch9_mesh_groundwater",        # -> hydrology_ref_ch10_planned when it lands
    ...
    "routing.anderson": H + "ch3_anderson",
    ...
    "fv.lts": H + "ch8_lts",
    "fv.node_coupling_keys": H + "ch10_planned",
    "fv.implicit_hypre": H + "ch10_planned",
    "fv.bed_step_junction_faces": H + "ch10_planned",
    "fv.tpa_high_celerity_fix": H + "ch10_planned",
    "friction.unsteady_vitkovsky": H + "ch3_dynamic_wave",
    "backend.1d.cpu": H + "ch8_finite_volume",
    "backend.1d.gpu": H + "ch10_planned",
    "junctions.virtual": H + "ch3_dynamic_wave",
    "junctions.virtual_momentum_full": H + "ch10_planned",
    ...
    "xsect.chebyshev_irregular": H + "ch10_planned",
    ...
    "overland2d.integrator.cvode": H + "ch10_planned",
    "overland2d.imex": H + "ch10_planned",
    "overland2d.advection_key": H + "ch10_planned",
    ...
    "backend.2d.metal": H + "ch10_planned",
    ...
    "transport.mesh_2d": Q + "ch10_mesh_quality",
    "transport.fv_mesh_pollutants": Q + "ch11_planned",
    "reactions.first_order": Q + "ch5_transport_treatment",
    "reactions.msx": Q + "ch8_msx_reactions",
    "reactions.bw_msx": Q + "ch10_mesh_quality",
    "water_age": Q + "ch9_age_heat",
    "heat": Q + "ch9_age_heat",
    "heat.per_element_attributes": Q + "ch11_planned",
    "sediment": Q + "ch11_planned",
...
TITLE_REFS = {
    ...
    "Rain on the mesh": Y + "ch8_mesh_surface",
    "Per-cell infiltration": Y + "ch8_mesh_surface",
    "Overland flow": H + "ch9_two_dimensional",
    "Mesh and closure": H + "ch9_two_dimensional",
    "Surface quality · transport": Q + "ch10_mesh_quality",
    "Backends": H + "ch9_two_dimensional",
    "Two-zone aquifer": Y + "ch5_groundwater",
    "Groundwater transport": Y + "ch9_mesh_groundwater",       # -> hydrology_ref_ch10_planned when it lands
    "Two-layer aquifer": Y + "ch9_mesh_groundwater",
    "Nodes": S + "JUNCTIONS",
    "Links": S + "CONDUITS",
    ...
    "Per-cell infiltration · evaporation": Y + "ch8_mesh_surface",
    "2D surface quality": Q + "ch10_mesh_quality",
    ...
    "Dunne return flow": Y + "ch9_mesh_groundwater",
    "node–bed exchange": Y + "ch9_mesh_groundwater",
    "capillary rise · boundary ET": Y + "ch9_mesh_groundwater",
